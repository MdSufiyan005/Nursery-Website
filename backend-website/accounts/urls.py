...
from .views import (
    ...
    order_payment, callback, shipping_details,contact_page,my_orders,auth_combined_view,profile_view,search_suggestions
)
...
urlpatterns = [
    path("accounts/combined/", auth_combined_view, name="auth_combined"),
    path('', home, name='home'),
